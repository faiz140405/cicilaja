    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-2">
                ...
                {{-- <button @click="darkMode = !darkMode" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-white p-2 rounded-full transition duration-150 focus:outline-none">
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                {{-- <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                    <button @click="darkMode = !darkMode" class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-white focus:outline-none transition duration-150">
