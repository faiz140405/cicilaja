        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-8 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- Pastikan file form partial ini juga sudah support dark mode --}}
                    @include('admin.products.form')

                    <div class="mt-8 flex items-center">
                        <button type="submit" class="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-bold py-2 px-4 rounded transition duration-300 shadow-md">
                            Perbarui Produk
                        </button>
